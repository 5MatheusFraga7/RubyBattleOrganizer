...
RSpec.describe 'DungeonMasterController' do 
    ...
    let(:monster_test) { FactoryBot.create(:dm_monster, dungeon_master_id: dungeon_master_test.id ) }
    ...
    context 'DM PLAYER-BATTLEFIELD' do 
        ...
        describe 'DELETE ACTION PLAYER-BATTLEFIELD' do
            ...
            it 'field removed!' do
                expect(PlayerBattleField.find_by(id: player_battle_field.id)).to be_nil
            end
    ...
    context 'DM MONSTER-BATTLEFIELD' do 
        ...
        describe 'POST CREATE MONSTER-BATTLEFIELD' do 
            ...
            let(:monster_battle_field) { FactoryBot.create(:monster_battle_field, battle_field_id: battle_field_test.id, dm_monster_id: monster_test.id) }

            it  'status code 201' do 
    
                post '/api/v1/dungeon_master/create_monster_battle_field', params: { monster_battle_field: monster_battle_field, dungeon_master_id: dungeon_master_test.id }.to_json, headers: headers
                expect(response).to have_http_status(201)
            end 
        ...
        describe 'DELETE ACTION MONSTER-BATTLEFIELD' do
            ...
            before do 
                delete "/api/v1/dungeon_master/destroy_monster_battle_field/#{monster_battle_field.id}", params: { dungeon_master_id: dungeon_master_test.id }.to_json, headers: headers
            end 
